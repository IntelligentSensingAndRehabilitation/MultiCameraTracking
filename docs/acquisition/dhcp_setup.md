...
- The interface names will be listed, it will likely be something like enp#s0 where the # could be any number.
...
You add this under the max-lease-time line
...
Replace `eth0` with interface_name below
